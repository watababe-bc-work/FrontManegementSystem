    ...
    try {
      ...
      querySnapshot.forEach((postDoc) => {
        ...
        switch(postDoc.get('Status')){
            case '面接済み':
                stocklist += '<tbody class="Already_back"><tr><td class="center">'+ postDoc.get('Status') + '</td><td class="center">' + i + '</td><td class="center">' + postDoc.get('Receiver') + '</td><td class="bigTh" class="bigTh">' + postDoc.get('Media') + '</td><td class="center">' + postDoc.get('Station') + '</td><td class="bigTh_name">' + postDoc.get('Name') + '</td><td class="center">' + postDoc.get('Sex') + '</td><td class="center">' + postDoc.get('Age') + '</td><td class="center">' + postDoc.get('Nationality') + '</td><td>' + postDoc.get('Tel') + '</td><td class="bigTh_interviewDate">' + postDoc.get('InterviewDate') + "  " + postDoc.get('InterviewTime') + '</td><td class="bigTh center">' + postDoc.get('InterviewPlace') + '</td><td>' + postDoc.get("post") + '</td><td class="center">' + postDoc.get('Dormitory') + '</td><td>' + postDoc.get('ReceptionDate').toDate().toLocaleString('ja-JP', {year:'numeric',month:'numeric',day:'numeric',hour:'numeric',minute:'numeric'}) + '</td><td class="center">' +  '<a class="js-modal-open2"><button class="btn btn-success" onclick="EditContent(\''+postDoc.id+'\')">変更</button></a><button class="btn btn-danger" onClick="DeleteContent(\''+postDoc.id+'\',\''+ i +'\')">削除</button>' +'</td></tr><tr><td colspan="16" class="notice">' + postDoc.get('Notice') + '</td></tr><tr><td colspan="16"></td></tr></tbody>';
                break;
            ...
            case '入社':
                stocklist += '<tbody class="join_back"><tr><td class="center">'+ postDoc.get('Status') + '</td><td class="center">' + i + '</td><td class="center">' + postDoc.get('Receiver') + '</td><td class="bigTh">' + postDoc.get('Media') + '</td><td class="center">' + postDoc.get('Station') + '</td><td class="bigTh_name">' + postDoc.get('Name') + '</td><td class="center">' + postDoc.get('Sex') + '</td><td class="center">' + postDoc.get('Age') + '</td><td class="center">' + postDoc.get('Nationality') + '</td><td>' + postDoc.get('Tel') + '</td><td class="bigTh_interviewDate">' + postDoc.get('InterviewDate') + "  " + postDoc.get('InterviewTime') + '</td><td class="bigTh center">' + postDoc.get('InterviewPlace') + '</td><td>' + postDoc.get("post") + '</td><td class="center">' + postDoc.get('Dormitory') + '</td><td>' + postDoc.get('ReceptionDate').toDate().toLocaleString('ja-JP', {year:'numeric',month:'numeric',day:'numeric',hour:'numeric',minute:'numeric'}) + '</td><td class="center">' +  '<a class="js-modal-open2"><button class="btn btn-success" onclick="EditContent(\''+postDoc.id+'\')">変更</button></a><button class="btn btn-danger" onClick="DeleteContent(\''+postDoc.id+'\',\''+ i +'\')">削除</button>' +'</td></tr><tr><td colspan="16" class="notice">' + postDoc.get('Notice') + '</td></tr><tr><td colspan="16"></td></tr></tbody>';
                break; 

            case '退社':
                stocklist += '<tbody class="leave_back"><tr><td class="center">'+ postDoc.get('Status') + '</td><td class="center">' + i + '</td><td class="center">' + postDoc.get('Receiver') + '</td><td class="bigTh">' + postDoc.get('Media') + '</td><td class="center">' + postDoc.get('Station') + '</td><td class="bigTh_name">' + postDoc.get('Name') + '</td><td class="center">' + postDoc.get('Sex') + '</td><td class="center">' + postDoc.get('Age') + '</td><td class="center">' + postDoc.get('Nationality') + '</td><td>' + postDoc.get('Tel') + '</td><td class="bigTh_interviewDate">' + postDoc.get('InterviewDate') + "  " + postDoc.get('InterviewTime') + '</td><td class="bigTh center">' + postDoc.get('InterviewPlace') + '</td><td>' + postDoc.get("post") + '</td><td class="center">' + postDoc.get('Dormitory') + '</td><td>' + postDoc.get('ReceptionDate').toDate().toLocaleString('ja-JP', {year:'numeric',month:'numeric',day:'numeric',hour:'numeric',minute:'numeric'}) + '</td><td class="center">' +  '<a class="js-modal-open2"><button class="btn btn-success" onclick="EditContent(\''+postDoc.id+'\')">変更</button></a><button class="btn btn-danger" onClick="DeleteContent(\''+postDoc.id+'\',\''+ i +'\')">削除</button>' +'</td></tr><tr><td colspan="16" class="notice">' + postDoc.get('Notice') + '</td></tr><tr><td colspan="16"></td></tr></tbody>';
                break;     
...
function EditContent(id){
    (async () => {
        try {
            ...
            //役職
            var post_elements = document.getElementById('post_edit');
            switch(carrentinterviewDB.get('post')){
                case '総合管理':
                    post_elements.options[1].selected = true;
                    break;
                case '運営':
                    post_elements.options[2].selected = true;
                    break;
                case 'メンテ':
                    post_elements.options[3].selected = true;   
                    break;
                case 'フロント':
        ...
        try {
            ...
            switch(status){
                ...
                case 'リスケジュール':
                    ...
                    break; 
                case '入社':
                    query = query.where('Status','==','入社');
                    break;     
                case '退社':
                    query = query.where('Status','==','退社');
                    break;  
                case '':
                    //検索なし
                    break;  
