        ...
        try {
            if(occurrenceDate.value != '' && dueDate.value != '' && storenameAdd.value != "" && fix.value != ""){
                ...
                db.collection('memorandum').add({
                    ...
                    storeName: storenameAdd.textContent,
...
if(getParam('storename')){
    ...
    storenameAdd.textContent = getParam('storename');
    storenameSearch.textContent = getParam('storename');
    storenameEdit.textContent = getParam('storename');
}
